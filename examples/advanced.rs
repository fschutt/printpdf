...
fn main() {
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("Advanced Text Positioning and Styling".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::EndTextSection,
    ]);
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("1. Normal text without spacing:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
        ...
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("Text with added character spacing:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
    ...
    }).flatten().collect::<Vec<_>>().iter().cloned());
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("4. Kerned text with manual adjustments:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("5. Text with different rendering modes:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
    ...
    ops.extend_from_slice(&[
        ...
        Op::SetTextRenderingMode { mode: TextRenderingMode::Fill },
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("6. Text with horizontal scaling:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("This is text with normal word spacing.".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("This is text with extra word spacing.".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("This is text with even more word spacing.".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::EndTextSection,
    ]);
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("8. Mixed fonts in a single line:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
