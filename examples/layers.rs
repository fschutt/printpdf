...
fn main() {
    ...
    ops.extend_from_slice(&[
        ...
        Op::DrawPolygon {
            polygon: Polygon {
                rings: vec![PolygonRing {
                    points: vec![
                        LinePoint {
                            p: Point { x: Pt(0.0), y: Pt(0.0) },
                            bezier: false,
                        },
                        LinePoint {
                            p: Point { x: Pt(595.0), y: Pt(0.0) }, // A4 width in points
                            bezier: false,
                        },
                        LinePoint {
                            p: Point { x: Pt(595.0), y: Pt(842.0) }, // A4 height in points
                            bezier: false,
                        },
                        LinePoint {
                            p: Point { x: Pt(0.0), y: Pt(842.0) },
                            bezier: false,
                        },
                    ],
                }],
        ...
        Op::EndLayer { layer_id: bg_layer_id.clone() },
    ]);
    ...
    ops.extend_from_slice(&[
        ...
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("This PDF demonstrates the use of layers (also called Optional Content Groups).".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("The content is organized in three separate layers:".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("1. Background - light gray background".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("2. Text Content - the text you're reading now".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("3. Graphics - shapes and visual elements".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::AddLineBreak,
        Op::AddLineBreak,
        Op::WriteTextBuiltinFont { 
            items: vec![TextItem::Text("In a PDF viewer that supports layers, you can toggle these on and off.".to_string())], 
            font: BuiltinFont::Helvetica 
        },
        Op::EndTextSection,
        Op::EndLayer { layer_id: text_layer_id.clone() },
    ]);
    
    // Graphics layer content
    ops.extend_from_slice(&[
        Op::BeginLayer { layer_id: graphics_layer_id.clone() },
        ...
        Op::DrawPolygon {
            polygon: Polygon {
                rings: vec![PolygonRing {
                    points: vec![
                        LinePoint {
                            p: Point { x: Pt(100.0), y: Pt(100.0) },
                            bezier: false,
                        },
                        LinePoint {
                            p: Point { x: Pt(200.0), y: Pt(100.0) },
                            bezier: false,
                        },
                        LinePoint {
        ...
        Op::DrawPolygon {
            polygon: Polygon {
                rings: vec![PolygonRing {
                    points: vec![
                        LinePoint {
                            p: Point { x: Pt(300.0), y: Pt(100.0) },
                            bezier: false,
                        },
                        LinePoint {
                            p: Point { x: Pt(400.0), y: Pt(100.0) },
                            bezier: false,
                        },
                        LinePoint {
                            p: Point { x: Pt(350.0), y: Pt(180.0) },
                            bezier: false,
                        },
                    ],
                }],
        ...
        Op::DrawLine {
            line: Line {
                points: vec![
                    LinePoint {
                        p: Point { x: Pt(450.0), y: Pt(100.0) },
                        bezier: false,
                    },
                    LinePoint {
                        p: Point { x: Pt(550.0), y: Pt(180.0) },
                        bezier: false,
                    },
                ],
                is_closed: false,
        ...
        Op::DrawLine {
            line: Line {
                points: vec![
                    LinePoint {
                        p: Point { x: Pt(450.0), y: Pt(130.0) },
                        bezier: false,
                    },
                    LinePoint {
                        p: Point { x: Pt(550.0), y: Pt(210.0) },
                        bezier: false,
                    },
                ],
                is_closed: false,
        ...
        Op::EndLayer { layer_id: graphics_layer_id.clone() },
    ]);
